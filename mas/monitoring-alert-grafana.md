...
Manage system Exception | mas_manage_systemexception_total | error count metrics
Manage Applicaiton Exception | mas_manage_applicationexception_total | error count metrics
